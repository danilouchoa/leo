...
const buttonVariants = cva(
  'inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-[var(--font-montserrat)] font-semibold ring-offset-background transition-all duration-300 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/40 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 hover:scale-105',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-oraex-light text-oraex-light bg-transparent hover:bg-oraex-light/10 hover:text-white',
        secondary:
          'bg-secondary text-secondary-foreground hover:bg-secondary/80',
        ghost: 'hover:bg-accent hover:text-accent-foreground',
        link: 'text-primary underline-offset-4 hover:underline',
        expandIcon:
          'group relative border border-input bg-[#1B1B1E] text-blue-200 hover:bg-accent hover:text-yellow-200',
        ringHover:
    ...
    defaultVariants: {
      variant: 'outline', // aplica a nova versão customizada
      size: 'default',
    },
  }
);
